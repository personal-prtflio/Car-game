...
fontLoader.load('https://unpkg.com/three@0.160.0/examples/fonts/helvetiker_regular.typeface.json', (font) => {
    const textGeo = new TextGeometry('Please dont ever feel like this is me trying to pull you back.\n I understand the depth of the pain I caused you, and because I finally understand it, I will never, ever force myself into your life or try to make you mine again. \n Your peace matters more to me than my own longings. I dont expect anything in return for these words. What I want to show you now isnt desperation; it is just absolute, enduring gratefulness.', { font: font, size: 1, height: 0.5 });
